...
def display(nx=5, ny=10):
    ...
    for j in range(ny):
        for i in range(nx):
            k += 1
            s = '%d' % (qrs+k)
            o += QRCode(s, 2).svg(100+380*i, 150+440*j, 10, s) 
    return o + '</svg>\n'
